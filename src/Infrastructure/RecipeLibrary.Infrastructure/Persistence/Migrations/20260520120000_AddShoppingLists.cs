...
namespace RecipeLibrary.Infrastructure.Persistence.Migrations
{
    ...
    public partial class AddShoppingLists : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OwnerUserId = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StoreOrder = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShoppingLists_ShoppingListGroups_GroupId",
                        column: x => x.GroupId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RecipeTitle = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingLists_GroupId_StoreOrder",
                table: "ShoppingLists",
                columns: new[] { "GroupId", "StoreOrder" },
                unique: true);
        ...
        {
            migrationBuilder.DropTable(name: "ShoppingListItemSources");
            migrationBuilder.DropTable(name: "ShoppingListItems");
            migrationBuilder.DropTable(name: "ShoppingLists");
            migrationBuilder.DropTable(name: "ShoppingListGroups");
        }
    }
}
